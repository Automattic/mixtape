...
class Mixtape_Model_Field_DeclarationTest extends Mixtape_Testing_Model_TestCase {
    ...
    function test_field_declarations() {
        ...
        $sum_declaration = (new Mixtape_Model_Field_Declaration_Builder())
            ->with_data_store_type(Mixtape_Model_Field_Declaration::FIELD)
            ->named( 'sum' )
        ...
        $first_name_declaration = (new Mixtape_Model_Field_Declaration_Builder())
            ->with_data_store_type(Mixtape_Model_Field_Declaration::FIELD)
            ->named( 'first_name' )
        ...
        $derived_declaration = (new Mixtape_Model_Field_Declaration_Builder())
            ->with_data_store_type(Mixtape_Model_Field_Declaration::DERIVED)
            ->named( 'derived' )
            ->build();
    ...
    function test_get_description_default_to_name() {
        $field =(new Mixtape_Model_Field_Declaration_Builder())
            ->with_data_store_type(Mixtape_Model_Field_Declaration::FIELD)
    ...
    function test_as_item_schema_property_contain_choices_if_set() {
        ...
        $builder->with_data_store_type(Mixtape_Model_Field_Declaration::FIELD)
            ->choices( $choices )
