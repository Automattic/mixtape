...
class Mixtape_Rest_Api_Controller_Builder implements Mixtape_Interfaces_Builder {
	...
	public function with_class( $controller_class ) {
		if ( ! class_exists( $controller_class ) ) {
			throw new Mixtape_Exception( 'class ' . $controller_class . ' does not exist' );
		}
	...
	public function crud( $base = null ) {
		...
		return $this->with_class( 'Mixtape_Rest_Api_Controller_CRUD' );
	}

	public function settings() {
		return $this->with_class( 'Mixtape_Rest_Api_Controller_Settings' );
	}
