...
class Mixtape_Model implements Mixtape_Interfaces_Model {
	 ...
	 *
	 * @param Mixtape_Model_Definition $definition The Definition.
	 * @param array                    $data The data array.
	 *
	 * @throws Mixtape_Exception Throws when data is not an array.
	 */
	 ...
	 *
	 * @return mixed
	 * @throws Mixtape_Exception Fails when field is unknown.
	 */
	 ...
	 *
	 * @return $this
	 * @throws Mixtape_Exception Throws when trying to set an unknown field.
	 */
	public function set( $field, $value ) {
		 ...
		 * The declaration.
		 *
		 * @var Mixtape_Model_Field_Declaration $field_declaration The declaration.
		 */
	 ...
	 *
	 * @param Mixtape_Model_Field_Declaration $field_declaration The field.
	 *
	 ...
	 *
	 * @param Mixtape_Model_Field_Declaration $field_declaration The declaration to use.
	 * @return mixed
	 */
	 ...
	 *
	 * @param Mixtape_Model_Field_Declaration $field_declaration The field declaration.
	 */
