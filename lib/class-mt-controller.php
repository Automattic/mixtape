...
class MT_Controller extends WP_REST_Controller {
	...
	/**
	 * @var MT_Controller_Bundle the bundle this belongs to
	 */
	...
	/**
	 * @var null|MT_Environment optional, an enviromnent
	 */
	 ...
	 *
	 * @param $controller_bundle MT_Controller_Bundle
	 * @param null|MT_Environment                             $environment
	 * @throws MT_Exception
	 */
	public function __construct( $controller_bundle = null, $environment = null ) {
		$this->controller_bundle = $controller_bundle;
		if ( empty( $this->base ) ) {
			throw new MT_Exception( 'Need to put a string with a backslash in $base' );
		}
	...
	/**
	 * @param MT_Environment|null $environment
